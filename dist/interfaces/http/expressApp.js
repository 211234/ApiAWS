...
const materiaController_1 = require("../../adapters/controllers/materiaController");
...
app.post('/api/duendeses', materiaController_1.createMateria);
app.get('/api/duendeses/:id', materiaController_1.getMateriaById);
app.get('/api/duendeses', materiaController_1.getAllMateriaes);
app.put('/api/duendeses/:id', materiaController_1.updateMateria);
app.delete('/api/duendeses/:id', materiaController_1.deleteMateriaById);
exports.default = app;
