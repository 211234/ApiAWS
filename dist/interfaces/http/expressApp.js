...
app.post('/api/materia', materiaController_1.createMateria);
app.get('/api/materia/:id', materiaController_1.getMateriaById);
app.get('/api/materia', materiaController_1.getAllMateriaes);
app.put('/api/materia/:id', materiaController_1.updateMateria);
app.delete('/api/materia/:id', materiaController_1.deleteMateriaById);
exports.default = app;
