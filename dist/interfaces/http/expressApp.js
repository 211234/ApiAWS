...
const duendesController_1 = require("../../adapters/controllers/duendesController");
...
app.post('/api/duendeses', duendesController_1.createDuendes);
app.get('/api/duendeses/:id', duendesController_1.getDuendesById);
app.get('/api/duendeses', duendesController_1.getAllDuendeses);
app.put('/api/duendeses/:id', duendesController_1.updateDuendes);
app.delete('/api/duendeses/:id', duendesController_1.deleteDuendesById);
exports.default = app;
