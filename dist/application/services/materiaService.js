...
class MateriaService {
    ...
    static createMateria(name, description) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield MateriaService.materiaRepository.save(materia);
        });
    }
    static getMateriaById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield MateriaService.materiaRepository.findById(id);
        });
    }
    static getAllMateriaes() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield MateriaService.materiaRepository.findAll();
        });
    }
    static updateMateria(id, name, description) {
        return __awaiter(this, void 0, void 0, function* () {
            const materia = new materia_1.default(id, name, description);
            return yield MateriaService.materiaRepository.update(materia);
        });
    }
    static deleteMateriaById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield MateriaService.materiaRepository.deleteById(id);
        });
    }
}
